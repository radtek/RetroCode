========================================================================
		ActiveX Control DLL : STEVEMEDIACENTEROCX
========================================================================

ControlWizard has created this project for your STEVEMEDIACENTEROCX ActiveX Control
...
SteveMediaCenterOcx.odl
	This file contains the Object Description Language source code for the
	type library of your control.

/////////////////////////////////////////////////////////////////////////////
SteveMediaCenterOcx control:

SteveMediaCenterOcxCtl.h
	This file contains the declaration of the CSteveMediaCenterOcxCtrl C++ class.

SteveMediaCenterOcxCtl.cpp
	This file contains the implementation of the CSteveMediaCenterOcxCtrl C++ class.

SteveMediaCenterOcxPpg.h
	This file contains the declaration of the CSteveMediaCenterOcxPropPage C++ class.

SteveMediaCenterOcxPpg.cpp
	This file contains the implementation of the CSteveMediaCenterOcxPropPage C++ class.

SteveMediaCenterOcxCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CSteveMediaCenterOcxCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file SteveMediaCenterOcx.rc.
