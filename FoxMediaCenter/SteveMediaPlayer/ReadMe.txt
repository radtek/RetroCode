========================================================================
		ActiveX Control DLL : STEVEMEDIAPLAYER
========================================================================

ControlWizard has created this project for your STEVEMEDIAPLAYER ActiveX Control
...
that make up your STEVEMEDIAPLAYER ActiveX Control DLL.

SteveMediaPlayer.dsp
...
SteveMediaPlayer.odl
	This file contains the Object Description Language source code for the
	type library of your control.

/////////////////////////////////////////////////////////////////////////////
SteveMediaPlayer control:

SteveMediaPlayerCtl.h
	This file contains the declaration of the CSteveMediaPlayerCtrl C++ class.

SteveMediaPlayerCtl.cpp
	This file contains the implementation of the CSteveMediaPlayerCtrl C++ class.

SteveMediaPlayerPpg.h
	This file contains the declaration of the CSteveMediaPlayerPropPage C++ class.

SteveMediaPlayerPpg.cpp
	This file contains the implementation of the CSteveMediaPlayerPropPage C++ class.

SteveMediaPlayerCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CSteveMediaPlayerCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file SteveMediaPlayer.rc.
