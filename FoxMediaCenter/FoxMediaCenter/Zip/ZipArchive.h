...
/**
	...
	\param	lpszPath
		The PATH only to extract the file to. May not be NULL.
	\param	bFullPath <BR>
...
/**
	...
	\param	pCallback
		\link callbFas callback function \endlink (may be NULL) 
	\param	pUserData
		user - defined data passed on to the callback function
		(doesn't matter if there is no callback function defined)
	\param	uBufSize
