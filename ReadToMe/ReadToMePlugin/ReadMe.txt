========================================================================
    ACTIVE TEMPLATE LIBRARY : ReadToMePlugin Project Overview
========================================================================

AppWizard has created this ReadToMePlugin project for you to use as the starting point for
...
_ReadToMePlugin.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (_ReadToMePlugin.h)
        GUID definitions                                (_ReadToMePlugin_i.c)
        A type library                                  (_ReadToMePlugin.tlb)
        Marshaling code                                 (_ReadToMePlugin_p.c and dlldata.c)
ReadToMePlugin.cpp
...
StdAfx.h, StdAfx.cpp
    ...
    named ReadToMePlugin.pch and a precompiled types file named StdAfx.obj.
...
ReadToMePluginps.vcproj
	...
	dlldata.c, ReadToMePlugin_i.c and ReadToMePlugin_p.c which are required
	to build the proxy/stub DLL.

ReadToMePluginps.def
    This module definition file provides the linker with information about the exports
